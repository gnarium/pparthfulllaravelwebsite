            ...
            <div class="container">
                <div className="row">
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        <div class="copyright" >
                            <p>Copyright &copy; Parth Charitable Trust 2021. <a href="https://www.gnariumiqnovative.com" style="color:#ffffff;">Designed & Developed By Gnarium Iqnovative Pvt. Ltd.</a></p>
                        </div>
                         <!-- copyright -->
                    </div>
